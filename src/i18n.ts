    ...
    resources: {
      ko: {
        translation: {
          ...
          "site.keywords":
            "약국 관리, AI 약국, 스마트 약국, 처방전 관리, 약국 자동화, 약국 POS, 약국 재고관리, 약국 매출관리, 약국 데이터분석, 약국 운영시스템",
          ...
          "home.subtitle":
            "마이팜는 인공지능과 자동화 기술을 활용해 약국 운영을 혁신하는 통합 플랫폼을 제공합니다",
          "home.ai.title": "AI로 약국 운영 최적화",
          "home.ai.description":
            "마이팜는 약국 운영의 모든 측면을 자동화하고 최적화하여 약사님들이 본연의 업무에 집중할 수 있도록 도와드립니다. 처방전 관리부터 재고 자동화, 매출 분석까지 약국 경영에 필요한 모든 것을 한 곳에서 관리하세요.",
          ...
          "home.opensource.description":
            "약국 관리 프로그램이 대체조제 엑셀을 NDSD(심평원)에 자동 업로드하는 Electron 모듈을 오픈소스로 공개했습니다. GitHub에서 코드를 확인하거나 Windows 설치 파일을 바로 내려받아 사용해 보세요.",
          "home.opensource.repo": "GitHub 저장소 보기",
          "home.opensource.download": "Windows 설치 파일 다운로드",
          "home.opensource.note":
            "최신 릴리스로 자동 연결됩니다. (Windows 64bit, .exe)",
          ...
          "product.crm.description":
            "고객 데이터를 분석하고 맞춤형 서비스를 제공하는 스마트 CRM 시스템",
          ...
          "customer.support.description":
            "마이팜 솔루션과 서비스에 관한 문의사항이 있으시면 아래 연락처로 문의해 주세요. 평일 09:00~18:00 사이에 전문 기술 지원팀이 신속하게 응대해 드립니다.",
          ...
          "customer.faq.a1":
            "모든 규모의 약국에 맞춤형으로 제공됩니다. 소형 개인 약국부터 대형 체인 약국까지 규모와 필요에 맞게 확장 가능한 솔루션을 제공합니다.",
          "customer.faq.q2": "기존 약국 시스템과 통합이 가능한가요?",
          "customer.faq.a2":
            "네, 가능합니다. 팜스퀘어는 개방형 API를 통해 기존 약국 시스템과 쉽게 통합할 수 있습니다. 저희 기술팀이 원활한 마이그레이션을 도와드립니다.",
          "customer.faq.q3": "데이터 보안은 어떻게 보장되나요?",
          "customer.faq.a3":
            "팜스퀘어는 개인정보보호법을 준수하는 엄격한 보안 프로토콜을 적용하고 있습니다. 256비트 암호화, 다중 인증 시스템, 그리고 정기적인 보안 감사를 통해 고객 데이터를 안전하게 보호합니다.",
          "customer.faq.q4": "서비스 구독 비용은 어떻게 되나요?",
          "customer.faq.a4":
            "다양한 구독 플랜을 제공하고 있으며, 약국 규모와 필요한 기능에 따라 비용이 달라집니다. 기본 플랜은 월 33,000원부터 시작하며, 상세한 가격 정보는 영업팀에 문의해 주세요.",
          "customer.faq.q5": "시스템 사용법 교육은 제공되나요?",
          "customer.faq.a5":
            "모든 구독 플랜에는 초기 시스템 설정 및 기본 사용법 교육이 포함되어 있습니다. 추가적인 심화 교육이나 맞춤형 트레이닝도 제공하고 있으며, 언제든지 온라인 교육 자료를 통해 학습하실 수 있습니다.",
          ...
          "customer.docs.description":
            "사용 가이드, API 문서, 동영상 튜토리얼 제공",
          ...
          "products.list.core.1.description":
            "인공지능으로 약국 운영 전반을 최적화하는 올인원 플랫폼",

          "products.list.automation.1.name":
            "가루약 자동 정량 토출기 - 메디믹스",
          "products.list.automation.1.description":
            "일일히 계량하는 가루약을 자동으로 정량 토출하는 기기",

          "products.list.core.2.name": "인공지능 복약 에이전트",
          "products.list.core.2.description":
            "처방 내용과 병원 정보를 분석하여 최적의 복약안내를 제안하는 인공지능 에이전트",

          "products.list.data.1.name": "경영 대시보드",
          "products.list.data.1.description":
            "약국 매출, 재고, 처방 데이터를 한눈에 볼 수 있는 대시보드",

          "products.list.automation.2.name": "자동 청구 시스템",
          "products.list.automation.2.description":
            "보험 청구 업무를 자동화하여 시간과 오류를 줄이는 솔루션",

          "products.list.marketing.1.name": "고객 관계 관리",
          "products.list.marketing.1.description":
            "환자 데이터를 관리하고 맞춤형 서비스를 제공하는 CRM 솔루션",

          "products.list.marketing.2.name": "디지털 마케팅 도구",
          "products.list.marketing.2.description":
            "약국 마케팅을 위한 디지털 툴과 자동화 캠페인 관리",

          "products.list.developer.1.name": "PharmSquare API",
          "products.list.developer.1.description":
            "외부 시스템과 통합할 수 있는 API 및 개발자 도구",

          // 회사 소개 페이지
          "about.title": "회사 소개",
          "about.subtitle":
            "마이팜는 약국 운영의 혁신을 이끄는 AI 기반 스마트 약국 관리 시스템을 제공합니다",
          "about.intro.title": "마이팜 소개",
          "about.intro.description1":
            "마이팜은 약국 현장의 데이터를 중심으로, 약사와 환자 모두를 위한 AI 기반 헬스케어 솔루션을 개발하는 디지털 헬스케어 기업입니다.",
          "about.intro.description2":
            "우리는 약국 업무 자동화 하드웨어인 '메디믹스', 그리고 복약지도 작성과 투약 관리 지원을 위한 소프트웨어 '팜스퀘어'를 통해 약사의 업무 부담을 줄이고, 환자에게는 더 정확하고 개인화된 복약 정보를 제공합니다.",
          "about.intro.description3":
            "마이팜은 단순한 기술 제공을 넘어, 약국 데이터를 기반으로 한 헬스케어 플랫폼으로 확장하고 있습니다. AI 기술과 정밀 분석을 바탕으로 처방 이력, 환자 상태, 복약 이탈 가능성 등을 종합적으로 판단하여, 맞춤형 건강 관리를 실현합니다.",
          "about.intro.description4":
            "우리는 기술이 약사의 전문성을 더욱 빛나게 하고, 환자에게는 더 따뜻한 복약 경험을 제공할 수 있다고 믿습니다.",
          "about.intro.description5":
            "2030년까지 글로벌 약국 경영 솔루션 시장을 선도하며, 약국 중심의 디지털 헬스케어 혁신을 이끄는 기업으로 성장하겠습니다.",

          "about.mission.title": "기업 미션",
          "about.mission.description":
            "약국 현장의 데이터를 연결하고 분석하여, 약사에게는 더 정확하고 효율적인 업무 환경을, 환자에게는 더 안전하고 따뜻한 복약 경험을 제공합니다. 기술을 넘어, 모두의 건강한 일상을 함께 만들어가는 헬스케어 파트너가 되겠습니다.",

          "about.vision.title": "비전",
          "about.vision.description":
            "우리는 2030년까지 약국 데이터를 기반으로 한 통합 헬스케어 플랫폼을 구축하여, 글로벌 약국 경영 솔루션 시장을 선도하고자 합니다. AI와 데이터 분석 역량을 바탕으로 약국을 환자 중심 의료의 핵심 거점으로 전환시키며, 보건의료 산업의 디지털 혁신을 이끄는 선두주자가 되겠습니다.",

          "about.values.title": "핵심 가치",
          "about.values.innovation.title": "혁신",
          "about.values.innovation.description":
            "끊임없는 기술 혁신으로 약국 운영의 미래를 만듭니다",
          "about.values.customer.title": "고객 중심",
          "about.values.customer.description":
            "약사와 환자의 필요를 최우선으로 생각합니다",
          "about.values.data.title": "데이터 기반",
          "about.values.data.description":
            "과학적 데이터 분석을 통한 의사결정을 지원합니다",
          "about.values.trust.title": "신뢰성",
          "about.values.trust.description":
            "안정적이고 신뢰할 수 있는 서비스를 제공합니다",

          "about.history.title": "연혁",
          "about.history.2026_press_dailypharm_opensource.title":
            "대체조제 통보 더 쉽게…오픈소스로 프로그램 만든 약사",
          "about.history.2026_press_dailypharm_opensource.description":
            "마이팜 대표 강재현 약사가 개발한 대체조제 사후통보 자동화 오픈소스 프로그램이 데일리팜에 소개되었습니다. 심평원 NDSD 통보를 원클릭으로 처리합니다.",
          "about.history.2025_press_dailypharm.title":
            '데일리팜 인터뷰 - "프로그램·조제장비 직접 개발"...소청과 약국 무한도전',
          "about.history.2025_press_dailypharm.description":
            "경기 평택 소아청소년과 인근 약국이 자체 개발한 약국 프로그램과 분말·시럽 조제장비로 효율을 높인 사례가 데일리팜에 소개되었습니다.",
          "about.history.2026_1.title":
            "인공지능 스타트업 달파와 서비스이관계약 체결",
          "about.history.2026_1.description":
            "마이팜 AI 스마트 약국 서비스의 차세대 기술 고도화를 위해 AI 스타트업 달파(Dalpha)와 서비스이관계약을 체결했습니다.",
          "about.history.2025_3.title":
            "중소벤처기업부 장관상 수상 - AI 스마트 복약지도 시스템",
          "about.history.2025_3.description":
            "AI 스마트 복약지도 시스템의 혁신성과 약국 현장 적용 성과를 인정받아 중소벤처기업부 장관상을 수상했습니다.",
          ...
          "about.history.2025_1.description":
            "네이버 그린하우스를 통해 최대 1억원 크레딧 제공",
          "about.history.2025.title":
            "마이팜(주),중소벤처진흥공단 창업성공패키지 선정",
          "about.history.2025.description":
            "인공지능 약국 관리 시스템 고도화 및 국내외 시장 확장을 위한 자본 마련",
          "about.history.2024_1.title": "팜스퀘어, 베타서비스 출시",
          "about.history.2024_1.description":
            "처방데이터 관리 및 조제 및 복약 간편 서비스 제공",
          "about.history.2024_2.title": "창업진흥원 예비창업패키지 선정",
          "about.history.2024_2.description":
            "정부지원금으로 창업 자본의 마중물을 마련",
          "about.history.2024_3.title": "마이팜 주식회사 설립",
          "about.history.2024_3.description":
            "약국 경영 혁신을 위한 스타트업 출범",

          "about.tech.title": "핵심 기술",
          "about.tech.ai.title": "AI 처방전 분석",
          "about.tech.ai.description":
            "딥러닝 기반 처방전 분석으로 약품 상호작용 검사 및 조제 업무 효율화",
          "about.tech.inventory.title": "예측형 재고 관리",
          "about.tech.inventory.description":
            "머신러닝을 활용한 약품 수요 예측 및 자동 발주 시스템",
          "about.tech.data.title": "빅데이터 분석",
          "about.tech.data.description":
            "약국 운영 데이터 분석을 통한 경영 인사이트 제공 및 의사결정 지원",
          ...
          "product.pharmsquare.description":
            "인공지능으로 약국 운영 전반을 최적화하는 올인원 플랫폼",
          ...
          "product.medimix.description":
            "정확하고 효율적인 가루약 정량 토출을 위한 자동화 시스템",
          ...
          "product.psinsight.description":
            "인공지능으로 맞춤형 복약지도를 자동 생성하는 스마트 솔루션",
          ...
          "product.dashboard.description":
            "약국 경영 데이터를 실시간으로 분석하고 인사이트를 제공하는 스마트 대시보드",
          ...
          "product.autocg.description":
            "건강보험 청구를 자동화하고 효율적으로 관리하는 스마트 시스템",
          ...
          "product.marketing.description":
            "데이터 기반의 맞춤형 마케팅을 자동화하는 스마트 시스템",
          ...
          "solutions.description":
            "마이팜는 약국 운영의 모든 측면을 혁신하는 다양한 솔루션을 제공합니다. AI 기술과 자동화를 통해 약사님들의 업무 효율성을 높이고, 환자들에게 더 나은 서비스를 제공할 수 있도록 지원합니다.",
      ...
      en: {
        translation: {
          ...
          "site.keywords":
            "pharmacy management, AI pharmacy, smart pharmacy, prescription management, pharmacy automation, pharmacy POS, inventory management, sales management, data analysis, pharmacy operation system",
          ...
          "home.subtitle":
            "MaiPharm provides an integrated platform that revolutionizes pharmacy operations using AI and automation technology",
          "home.ai.title": "Optimize Pharmacy Operations with AI",
          "home.ai.description":
            "MaiPharm automates and optimizes all aspects of pharmacy operations, allowing pharmacists to focus on their core duties. Manage everything from prescription management to inventory automation and sales analysis in one place.",
          "home.ai.button": "Learn More",

          "home.features.title": "Key Features",
          "home.features.subtitle":
            "Supporting pharmacy operations with various features",
          "home.features.ai.title": "AI Operation Automation",
          "home.features.ai.description":
            "Save time by automating routine pharmacy tasks with artificial intelligence",
          "home.features.data.title": "Integrated Data Management",
          "home.features.data.description":
            "Efficiently manage medications, customers, and prescription information in one system",
          "home.features.insight.title": "Business Insights",
          "home.features.insight.description":
            "Provide insights needed for pharmacy management through real-time data analysis",
          "home.features.security.title": "Security & Compliance",
          "home.features.security.description":
            "Provide a robust security system for medical data security and regulatory compliance",

          "home.solutions.title": "Solutions",
          "home.solutions.subtitle":
            "MaiPharm's innovative solutions for optimizing pharmacy operations",
          ...
          "home.opensource.description":
            "We've open-sourced an Electron module that auto-uploads alternative dispensing Excel files from pharmacy software to NDSD (HIRA). Browse the source on GitHub or download the Windows installer directly.",
          "home.opensource.repo": "View on GitHub",
          "home.opensource.download": "Download Windows installer",
          "home.opensource.note":
            "Always points to the latest release. (Windows 64-bit, .exe)",
          "home.opensource.badgeOss": "Open Source",
          "home.opensource.badgeLang": "TypeScript",
          "home.opensource.badgeStack": "Electron",
          ...
          "product.crm.description":
            "Smart CRM system that analyzes customer data and provides personalized services",
          ...
          "customer.subtitle":
            "Leave your inquiries and we will respond quickly",
          "customer.support.title": "Customer Support Guide",
          "customer.support.description":
            "If you have any questions about MaiPharm solutions and services, please contact us using the information below. Our technical support team will respond promptly during business hours (09:00-18:00 on weekdays).",
          ...
          "customer.faq.q1":
            "Which pharmacies are suitable for PharmSquare solutions?",
          "customer.faq.a1":
            "We provide customized solutions for pharmacies of all sizes. From small independent pharmacies to large chain pharmacies, our solutions are scalable to meet your specific needs.",
          "customer.faq.q2":
            "Can it be integrated with existing pharmacy systems?",
          "customer.faq.a2":
            "Yes, it can. PharmSquare can be easily integrated with existing pharmacy systems through our open API. Our technical team will assist you with a smooth migration process.",
          "customer.faq.q3": "How is data security ensured?",
          "customer.faq.a3":
            "PharmSquare implements strict security protocols compliant with privacy laws. We protect customer data through 256-bit encryption, multi-factor authentication, and regular security audits.",
          "customer.faq.q4": "What are the subscription costs?",
          "customer.faq.a4":
            "We offer various subscription plans, with costs varying based on pharmacy size and required features. Basic plans start at 33,000 KRW per month. Please contact our sales team for detailed pricing information.",
          "customer.faq.q5": "Is system usage training provided?",
          "customer.faq.a5":
            "All subscription plans include initial system setup and basic usage training. We also offer advanced training and customized training sessions, and you can learn through online training materials at any time.",

          "customer.visit.title": "Visit Consultation",
          "customer.visit.address":
            "204 Gongdan 1-daero, 32-dong 306-ho, Siheung-si, Gyeonggi-do",
          "customer.visit.hours": "Weekdays 09:00 - 18:00 (By appointment)",

          "customer.docs.title": "Technical Documentation",
          "customer.docs.description":
            "User guides, API documentation, and video tutorials",
          "customer.docs.status": "Coming Soon",

          "customer.chat.title": "Online Chat Support",
          "customer.chat.description":
            "Real-time chat consultation for quick problem resolution",
          ...
          // Product List
          "products.list.core.1.name":
            "AI Pharmacy Management System - PharmSquare",
          "products.list.core.1.description":
            "An all-in-one platform that optimizes pharmacy operations with artificial intelligence",

          "products.list.automation.1.name":
            "Powder Medicine Dispenser - MediMix",
          "products.list.automation.1.description":
            "Automated device for dispensing powdered medicines",

          "products.list.core.2.name": "AI Medication Agent",
          "products.list.core.2.description":
            "AI agent that analyzes prescription content and hospital information to suggest optimal medication guidance",

          "products.list.data.1.name": "Management Dashboard",
          "products.list.data.1.description":
            "Dashboard for viewing pharmacy sales, inventory, and prescription data at a glance",

          "products.list.automation.2.name": "Automated Billing System",
          "products.list.automation.2.description":
            "Solution that reduces time and errors by automating insurance billing tasks",

          "products.list.marketing.1.name": "Customer Relationship Management",
          "products.list.marketing.1.description":
            "CRM solution for managing patient data and providing personalized services",

          "products.list.marketing.2.name": "Digital Marketing Tools",
          "products.list.marketing.2.description":
            "Digital tools and automated campaign management for pharmacy marketing",

          "products.list.developer.1.name": "PharmSquare API",
          "products.list.developer.1.description":
            "API and developer tools for integration with external systems",

          // About Page
          "about.title": "About Us",
          "about.subtitle":
            "MaiPharm provides an AI-based smart pharmacy management system that leads innovation in pharmacy operations",
          "about.intro.title": "About MaiPharm",
          "about.intro.description1":
            "MaiPharm is a digital healthcare company developing AI-based healthcare solutions for both pharmacists and patients, centered around pharmacy field data.",
          "about.intro.description2":
            "Through our pharmacy automation hardware 'MediMix' and software 'PharmSquare' for medication guidance and management support, we reduce pharmacists' workload and provide more accurate and personalized medication information to patients.",
          "about.intro.description3":
            "Beyond simple technology provision, MaiPharm is expanding into a healthcare platform based on pharmacy data. Through AI technology and precise analysis, we comprehensively evaluate prescription history, patient status, and medication adherence possibilities to realize personalized healthcare.",
          "about.intro.description4":
            "We believe that technology can enhance pharmacists' expertise and provide patients with a warmer medication experience.",
          "about.intro.description5":
            "By 2030, we aim to lead the global pharmacy management solution market and grow into a company that drives digital healthcare innovation centered around pharmacies.",

          "about.mission.title": "Corporate Mission",
          "about.mission.description":
            "We connect and analyze pharmacy field data to provide pharmacists with more accurate and efficient work environments, and patients with safer and warmer medication experiences. Beyond technology, we will become a healthcare partner that creates healthy daily lives together.",

          "about.vision.title": "Vision",
          "about.vision.description":
            "By 2030, we aim to build an integrated healthcare platform based on pharmacy data and lead the global pharmacy management solution market. By transforming pharmacies into key hubs for patient-centered care through our AI and data analysis capabilities, we will become a leader in digital innovation in the healthcare industry.",

          "about.values.title": "Core Values",
          "about.values.innovation.title": "Innovation",
          "about.values.innovation.description":
            "Creating the future of pharmacy operations through continuous technological innovation",
          "about.values.customer.title": "Customer-Centric",
          "about.values.customer.description":
            "Prioritizing the needs of pharmacists and patients",
          "about.values.data.title": "Data-Driven",
          "about.values.data.description":
            "Supporting decision-making through scientific data analysis",
          "about.values.trust.title": "Reliability",
          "about.values.trust.description":
            "Providing stable and trustworthy services",

          "about.history.title": "History",
          "about.history.2026_press_dailypharm_opensource.title":
            "Daily Pharm Interview – Open-source Program to Simplify Generic Substitution Notifications",
          "about.history.2026_press_dailypharm_opensource.description":
            "Daily Pharm featured MaiPharm CEO pharmacist Jae-Hyun Kang's open-source program that handles HIRA NDSD post-substitution notifications with a single click.",
          "about.history.2025_press_dailypharm.title":
            'Daily Pharm Interview – "Self-developed Programs & Dispensing Equipment" Pediatric Pharmacy Challenge',
          "about.history.2025_press_dailypharm.description":
            "Daily Pharm featured a pharmacy in Pyeongtaek that boosted efficiency with self-developed pharmacy software and powder/syrup dispensing equipment.",
          "about.history.2026_1.title":
            "Service Transfer Agreement Signed with AI Startup Dalpha",
          "about.history.2026_1.description":
            "Signed a service transfer agreement with AI startup Dalpha to advance the next generation of MaiPharm AI smart pharmacy service.",
          "about.history.2025_3.title":
            "Minister's Award from the Ministry of SMEs and Startups - AI Smart Medication Guidance System",
          "about.history.2025_3.description":
            "Received the Minister's Award from the Ministry of SMEs and Startups in recognition of the innovation and field-proven impact of the AI smart medication guidance system.",
          "about.history.2025.title":
            "Selected for Startup Success Package by the Korea SMEs and Startups Agency",
          "about.history.2025.description":
            "Started PharmSquare enhancement and additional hardware development",
          "about.history.2025_2.title": "Patent Registration Completed",
          "about.history.2025_2.description":
            "Powder Medicine Dispenser Patent Registration",
          "about.history.2025_1.title":
            "Selected for the Naver Startup Support Program",
          "about.history.2025_1.description":
            "Provided up to 100 million won in credit through Naver Green House",
          "about.history.2024_1.title": "PharmSquare Beta Service Launch",
          "about.history.2024_1.description":
            "Service introduced to 4 domestic pharmacies",
          "about.history.2024_2.title":
            "Selected for the Pre-Startup Package by the Korea Institute of Startup and Entrepreneurship Development",
          "about.history.2024_2.description":
            "Initial funding for business startup",
          "about.history.2024_3.title": "MaiPharm Corporation Established",
          "about.history.2024_3.description":
            "Startup launch for pharmacy management innovation",

          "about.tech.title": "Core Technologies",
          "about.tech.ai.title": "AI Prescription Analysis",
          "about.tech.ai.description":
            "Deep learning-based prescription analysis for drug interaction testing and dispensing efficiency",
          "about.tech.inventory.title": "Predictive Inventory Management",
          "about.tech.inventory.description":
            "Machine learning-based drug demand prediction and automatic ordering system",
          "about.tech.data.title": "Big Data Analysis",
          "about.tech.data.description":
            "Providing business insights and decision support through pharmacy operation data analysis",
          ...
          "product.pharmsquare.benefits": [
            {
              ...
              description:
                "30% reduction in pharmacist work time through AI-based automation",
            },
            {
            ...
            },
            {
              ...
              description:
                "40% improvement in customer satisfaction through personalized services",
            },
          ],
          "product.medimix.name": "Powder Medicine Dispenser - MediMix",
          "product.medimix.category": "Automation Equipment",
          "product.medimix.description":
            "Automated system for accurate and efficient powder medicine dispensing",
          ...
          "product.psinsight.name":
            "AI Medication Guide Generator - PharmSquare Insight",
          "product.psinsight.category": "Core Solution",
          "product.psinsight.description":
            "Smart solution that automatically generates personalized medication guides using artificial intelligence",
          ...
          "product.dashboard.name":
            "AI Management Dashboard - MaiPharm Dashboard",
          "product.dashboard.category": "Business Analytics",
          "product.dashboard.description":
            "Smart dashboard that analyzes pharmacy management data in real-time and provides insights",
          ...
          "product.dashboard.benefits": [
            {
              ...
              description:
                "25% increase in sales through AI-based optimization",
            },
            {
              title: "Better Decision Making",
              description:
                "40% improvement in operational efficiency through data-driven decisions",
            },
            {
              title: "Increased Customer Satisfaction",
              description:
                "35% increase in customer return rate through personalized services",
            },
          ],
          "product.autocg.name": "Automated Billing System - AutoCG",
          "product.autocg.category": "Billing Management",
          "product.autocg.description":
            "Smart system that automates and efficiently manages health insurance billing",
          ...
          "product.marketing.name":
            "Marketing Automation System - MaiPharm Marketing",
          "product.marketing.category": "Marketing",
          "product.marketing.description":
            "Smart system that automates data-driven personalized marketing",
          ...
          "product.api.description":
            "Secure and powerful API service for pharmacy systems",
          ...
          "banner.data.title":
            "New Paradigm in Data-Driven Pharmacy Management",
          "banner.automation.alt": "Automation Technology",
          "banner.automation.title":
            "Save Time and Costs with Pharmacy Work Automation",
          ...
          "solutions.subtitle":
            "MaiPharm's Innovative Solutions for Optimizing Pharmacy Operations",
          "solutions.description":
            "MaiPharm provides various solutions that revolutionize all aspects of pharmacy operations. Through AI technology and automation, we help pharmacists improve work efficiency and provide better services to patients.",

          "solutions.core.title": "Core Solutions",
          "solutions.core.description":
            "Essential solutions for pharmacy operations",
          "solutions.core.items": [
            {
              title: "AI Prescription Analysis",
              description:
                "Enhance pharmacist efficiency through AI-powered prescription analysis",
            },
            {
              title: "Inventory Management System",
              description:
                "Real-time inventory monitoring and automatic ordering system",
            },
            {
          ...
          "solutions.automation.description":
            "Maximize efficiency through task automation",
          "solutions.automation.items": [
            {
              title: "Powder Medicine Dispenser",
              description:
                "Accurate and efficient automation of powder medicine prescriptions",
            },
            {
              title: "Automated Billing System",
              description:
                "Save time through automated insurance claim processing",
            },
            {
          ...
          "solutions.data.description":
            "Smart pharmacy operations based on data",
          "solutions.data.items": [
            {
              title: "Customer Data Analysis",
              description:
                "Provide customized services through customer behavior pattern analysis",
            },
            {
          ...
          "solutions.marketing.description":
            "Tools for effective pharmacy marketing",
          "solutions.marketing.items": [
            {
          ...
          "solutions.developer.description":
            "Tools for pharmacy system development",
          "solutions.developer.items": [
            {
              title: "API Service",
